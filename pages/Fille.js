...
export default function Fille({ allProducts }) {
    ...
    <div className="mt-14 md:mt-6 w-full px-4 md:p-0">
      ...
      <div className="flex flex-col justify-center min-h-screen w-full">
        {loading ? (
          ...
          <>
            <div className="w-full mb-4" style={{ width: "100%", height: "450px" }}>
              <Slider dots={true} infinite={true} speed={500} slidesToShow={1} slidesToScroll={1} className="w-full h-full">
                <div>
                  <img src="  " alt="Carousel Image 1" style={{ width: "100%", height: "100%" }} />
                </div>
                <div>
                  <img src="https://scontent.ftun20-1.fna.fbcdn.net/v/t1.6435-9/187178165_10157709590996126_3035091224480332073_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=5f2048&_nc_ohc=euSJwneLVfsQ7kNvgEoFYfT&_nc_ht=scontent.ftun20-1.fna&oh=00_AYDslzKDC6dkZG4jhWFvHCivfdmbE-H86DdMFKo2WGKhAA&oe=66867427" alt="Carousel Image 2" style={{ width: "100%", height: "100%" }} />
                </div>
                <div>
                  <img src="https://cdn.create.vista.com/api/media/medium/337955902/stock-photo-panoramic-shot-beautiful-girl-trendy-suit-posing-torn-paper-isolated?token=" alt="Carousel Image 3" style={{ width: "100%", height: "100%" }} />
                </div>
              </Slider>
            </div>
            <div className="flex justify-between mb-4">
        <ProductFilter allProducts={allProducts} setFilteredProducts={setFilteredProducts} />
        <input
          type="text"
...
export async function getServerSideProps() {
  ...
  const allProducts = await Product.find({ gender: "Fille" }, null, { sort: { _id: 1 } }).populate('category');
