...
<footer class="bg-wihte py-5 font-sans tracking-wide">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-10 py-8">
        <div>
          <h4 class="text-lg font-semibold mb-6 text-black">À propos</h4>
          <p class="text-gray-400 text-base">Dress-up est un site e-commerce de recommandation qui propose une large gamme de produits et des systèmes de recommandation avancés.</p>
        </div>

        <div>
          <h4 class="text-lg font-semibold mb-6 text-black">Services</h4>
          <ul class="space-y-4">
            <li><a href="/Recommendation" class="text-gray-400 hover:text-black text-base">Recommandation</a></li>
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-black text-base">Mobile App Development</a>
            </li>
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-black text-base">UI/UX </a></li>
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-black text-base">Digital Marketing</a></li>
          </ul>
        </div>

        <div>
          <h4 class="text-lg font-semibold mb-6 text-black">Suivez-nous</h4>
          <ul class="space-y-4">
            <li><a href="" class="text-gray-400 hover:text-black text-base">Tunis,Ariana,Mnihla</a></li>
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-blacktext-base">Dress-up@gmail.com</a>
            </li>
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-black text-base">+216 54144380</a></li>
            
          </ul>
        </div>

        <div>
          <h4 class="text-lg font-semibold mb-6 text-black">Nous contacter</h4>

          <ul class="flex flex-wrap gap-x-5 gap-4">
            <li><a href="javascript:void(0)" class="text-xl">
            ...
            <li><a href="javascript:void(0)" class="text-xl">
              <svg xmlns="http://www.w3.org/2000/svg" class="inline w-6 h-6" viewBox="0 0 1227 1227">
      ...
      <div class="bg-orange-500 p-5 mt-12">
        <p class='text-white text-base text-center'>Copyright  Dress-up © 2024<a href='https://readymadeui.com/' target='_blank'
          class="hover:underline mx-1"></a>Tous droits réservés.</p>
      </div>
    </footer>
