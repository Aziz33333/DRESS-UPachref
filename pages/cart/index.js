                        ...
                        <li className="flex items-center gap-4 justify-between">
                          ...
                          <div>
                            ...
                            <dl className="mt-0.5 space-y-px text-[10px] text-text">
                              <p>DT .{cartProducts.filter(id => id === product._id).length * product.price}</p>
                            </dl>
                          </div>
                    ...
                    <div className=" max-w-md space-y-4">
                      <dl className="space-y-0.5 text-md text-gray-700">
                        ...
                        <div className="flex justify-between">
                          <dt>Sous-total</dt>
                          <dd>DT. {formatPrice(total)}</dd>
                        </div>

                        <strike className="flex justify-between">
                          <dt>VAT</dt>
                          <dd>DT. {formatPrice(total / 1000)}</dd>
                        </strike>
        ...
        {!products.length ? (
          ...
          <div className="md:1/3 mt-16 md:mt-6">
            <header className="text-start flex flex-col w-full">
              ...
              <p className="mt-2 text-text text-lg">Nous utilisons vos détails de compte pour l'expédition.</p>
            </header>
            <div class="mx-auto max-w-xl p-4 border shadow-xl h-[400px] my-3">
              <div class="space-y-5">
                <div class="grid grid-cols-12 gap-5">
                  ...
                  <div class="col-span-6">
                    <label class="mb-1 block text-sm font-medium text-text">Ville</label>
                  ...
                  <div class="col-span-4">
                    <label class="mb-1 block text-sm font-medium text-text">État</label>
                  ...
                  <div class="col-span-2">
                    <label class="mb-1 block text-sm font-medium text-text">code postal</label>
  ...
  return <>
    <div className="grid h-screen px-4 bg-white place-content-center">
      <div className="text-center">
        ...
        <p className="mt-4 text-text text-2xl">Vous devez vous inscrire pour afficher les articles du panier.</p>
