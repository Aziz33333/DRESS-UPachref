...
import GarconFilter from "./filter/GarconFilter";
...
export default function garçon({ allProducts }) {
      ...
      <div className="flex flex-col justify-center min-h-screen w-full">
        <div className="w-full mb-4" style={{ width: "100%", height: "500px" }}>
          <Slider dots={true} infinite={true} speed={500} slidesToShow={1} slidesToScroll={1} className="w-full h-full">
            <div>
              <img src="https://cdn.create.vista.com/api/media/small/684728790/stock-photo-adorable-african-american-siblings-stylish-denim-clothes-sitting-hugging-blue" alt="Carousel Image 1" style={{ width: "100%", height: "100%" }} />
            </div>
            <div>
        ...
        <GarconFilter allProducts={allProducts} setFilteredProducts={setFilteredProducts} />
        <input
          type="text"
...
export async function getServerSideProps() {
  ...
  const allProducts = await Product.find({ gender: "garçon" }, null, { sort: { _id: 1 } }).populate('category');
