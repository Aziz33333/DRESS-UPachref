          ...
          <>
            <div className="w-full mb-4" style={{ width: "100%", height: "450px" }}>
              <Slider dots={true} infinite={true} speed={500} slidesToShow={1} slidesToScroll={1} className="w-full h-full">
                <div>
                  <img src="https://images.zen.com.tn/medias/folder_03_06_2024/full_summer_zen_69a1bd8922.webp" alt="Carousel Image 1" style={{ width: "50%", height: "50%" }} />
                </div>
                <div>
                  <img src="https://cdn.create.vista.com/api/media/medium/337955902/stock-photo-panoramic-shot-beautiful-girl-trendy-suit-posing-torn-paper-isolated?token=" alt="Carousel Image 2" style={{ width: "100%", height: "100%" }} />
                </div>
                <div>
