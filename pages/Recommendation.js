        ...
        <div className="container mx-auto p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div className="p-6">
                        <h1 className="text-3xl font-bold text-center text-gray-800 mb-4">Système de recommandation de mode</h1>
                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div className="p-6">
                        <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">Images recommandées</h2>
                        {recommendations.length > 0 ? (
                            ...
                            <p className="text-center text-gray-600">Aucune recommandation pour le moment</p>
                        )}
                    </div>
                </div>
            </div>
